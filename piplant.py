...
avg = []
for x in range (0, 10):
	avg.append(read_temp_c())
average = sum(avg)/len(avg)
average = round(average, 2)
print(average)
average = str(average)

write_file = open('./pi_data.json', 'w')
write_file.write('{"int_temp":"')
write_file.write(average)
write_file.write('"}')
write_file.close()

os.system('fswebcam --no-banner ./pi-plant.jpg')
#os.system('node ./app.js')
#os.system('scp pi_data.json kulnahor@Rohans-MacBook-Pro:/Users/kulnahor/Desktop')
#os.system('scp pi-plant.jpeg kulnahor@Rohans-MacBook-Pro:/Users/kulnahor/Desktop')
